...
from src.model.ip_adapter_fuse.pipeline_orig import IPMakerFuseStableDiffusionXLPipeline
...
def main(config):
    ...
    visual_projection_3_params = filter(lambda p: p.requires_grad, model.id_encoder.visual_projection_3.parameters())
    ...
    trainable_params = [
        ...
        {'params': visual_projection_3_params, 'lr': config.lr_for_vis_proj_3, 'name': 'vis_proj_3_params'},
    ...
    if accelerator.is_main_process:
        ...
        pipe = IPMakerFuseStableDiffusionXLPipeline.from_pretrained(
