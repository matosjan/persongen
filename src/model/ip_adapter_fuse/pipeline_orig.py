...
class IPMakerFuseStableDiffusionXLPipeline(StableDiffusionXLPipeline):
    ...
    def load_photomaker_adapter(
        ...
        **kwargs,
        ...
        print('Loaded id encoder weights into pipeline')
    ...
    def __call__(
        ...
        **kwargs,
        ...
        prompt_embeds, ip_embeds = self.id_encoder(id_pixel_values, prompt_embeds, class_tokens_mask)    
