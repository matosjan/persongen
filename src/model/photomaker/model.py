...
class PhotoMaker():
    def __init__(self, pretrained_model_name_or_path, pretrained_vae_model_name_or_path, rank, weight_dtype, trigger_word='img'):
        ...
        self.id_encoder = self.id_encoder.to('cuda')  
